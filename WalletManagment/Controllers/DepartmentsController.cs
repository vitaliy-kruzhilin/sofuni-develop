...
using WalletManagment.Data;
using WalletManagment.Models;

namespace WalletManagment.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department = await _context.Departments.Where(w => w.DepartmentID == id).Include(d => d.Administrator).AsNoTracking().FirstOrDefaultAsync();
